...
## Wrangle dataframes
```{r MAIA Trusting FL: rectify raw scores which were incorrectly coded}
...
# Recode sessions 1 2 3 to baseline, midpoint, exit:
...
ft <- flextable(power_SESOI)

# Save as HTML
save_as_html(ft, path = "HCT_power_table.html")
ft
...
# Save as HTML
save_as_html(ft, path = "dprime_power_table.html")
...
power_SESOI <- mixedpower(model = model, data = power_df,
                              ...
                              critical_value = 2, n_sim = 500,
                              SESOI = SESOI, databased = T, maxCores = 5)
...
# Save as HTML
save_as_html(ft, path = "state_anxiety_power_table.html")
ft
...
# Save as HTML
save_as_html(ft, path = "trait_anxiety_power_table.html")
ft
...
# See code at bottom of this cell for Supplementary 8.1.3 and 8.1.4 (using absolute values of d')
...
# Rename 'Condition' column to 'Group'
# (temp_df)[names(temp_df) == "Condition"] <- "Group"
...
col <- 6 # Change from 1 through 8 to run LME
